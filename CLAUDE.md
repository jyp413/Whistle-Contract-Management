...
매년 재계약은 mou 상세의 `[갱신 착수]` 버튼으로 — 새 row가 `parent_contract_id=작년id`, `master_contract_id=메인id`, status='갱신중'으로 생성되며 부모의 type/party/master/amount/auto_renewal/memo가 prefill. 자세한 흐름은 invariant #14.
